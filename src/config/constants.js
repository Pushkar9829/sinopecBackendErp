...
const DEFAULT_SALES_OPTIONS = {
  productType: ['Finished Product', 'Semi-finished', 'Roll', 'Bag'],
  material: ['HDPE', 'LDPE', 'LLDPE', 'PP'],
  unit: ['pcs', 'kg', 'roll', 'm'],
  color: ['Blue', 'White', 'Natural', 'Black', 'Red'],
  ...
  materialType: ['Polymer', 'Film', 'Ink'],
  materialGrade: ['Film grade', 'Bag grade'],
  additive: ['UV stabilizer', 'Slip agent'],
  holeType: ['Round', 'Die cut', 'Handle'],
  holeSize: ['8 mm', 'Handle'],
  holePosition: ['Top', 'Top centre'],
  tapeType: ['Adhesive', 'BOPP'],
  printColor: ['Blue, White', 'Black', '4 color'],
  printDesign: ['Customer logo', 'Company logo'],
};
